...
class Config
{
    ...
    /**
     * @var Devise\Mothership\Logs\Senders\SenderInterface
     */
    private $sender;
...
//        $this->utilities->validateString($config['access_token'], "config['access_token']", 32, false);
    ...
    private function setDataBuilder($config)
    {
        ...
        $exp = "Devise\Mothership\Logs\DataBuilderInterface";
        $def = "Devise\Mothership\Logs\DataBuilder";
        $this->setupWithOptions($config, "dataBuilder", $exp, $def, true);
    }

    private function setTransformer($config)
    {
        $expected = "Devise\Mothership\Logs\TransformerInterface";
    ...
    {
        $this->setupWithOptions($config, "filter", "Devise\Mothership\Logs\FilterInterface");
    }

    private function setSender($config)
    {
        $expected = "Devise\Mothership\Logs\Senders\SenderInterface";
        
        $default = "Devise\Mothership\Logs\Senders\CurlSender";
    ...
    {
        $exp = "Devise\Mothership\Logs\ScrubberInterface";
        $def = "Devise\Mothership\Logs\Scrubber";
    ...
    private function setAgentSenderOptions(&$config, $default)
    {
        ...
        $default = "Devise\Mothership\Logs\Senders\AgentSender";
    ...
    private function setFluentSenderOptions(&$config, $default)
    {
        ...
        $default = "Devise\Mothership\Logs\Senders\FluentSender";
    ...
    {
        $this->setupWithOptions($config, "responseHandler", "Devise\Mothership\Logs\ResponseHandlerInterface");
    }
     ...
     * `use_error_reporting` config or `error_sample_rates` config.
     *
     * @param Devise\Mothership\Logs\ErrorWrapper $toLog
     *
     * @return bool
     */
