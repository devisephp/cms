...
class FluentSender implements SenderInterface
{
    ...
    {
        $this->fluentHost = Devise\Mothership\Logs\Defaults::get()->fluentHost();
        $this->fluentPort = Devise\Mothership\Logs\Defaults::get()->fluentPort();
        $this->fluentTag = Devise\Mothership\Logs\Defaults::get()->fluentTag();
    ...
    /**
     * @param Devise\Mothership\Logs\Payload\EncodedPayload $scrubbedPayload
     * @param $accessToken
     * @return Response
     *
