devise.define(['require', 'jquery', 'dvsDatePicker', 'dvsNetwork', 'dvsPageData', 'query', 'dvsSelectSurrogate', 'dvsListeners', 'jquery-ui'], function (require, $, datePicker, network, pageData, query, selectSurrogate, listeners)
{
    var node = null;
