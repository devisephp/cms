...
class Manager {
    ...
    {
        preg_match_all('/[a-zA-Z]/', URL::current(), $matches);
	...
	public function getIsMulti() {
		return Session::get($this->key . '_multisort');
	}
	...
	public function setIsMulti( $isMulti ) {
		return Session::put($this->key . '_multisort', $isMulti);
	}
	...
	{
		return Session::get($this->key, array());
	}

    public function clearStack()
    {
        Session::forget($this->key);
        Session::forget($this->key.'_multisort');
    }
    ...
    {
        return Session::put($this->key, $cookie);
    }
