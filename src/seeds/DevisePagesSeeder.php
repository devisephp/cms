    ...
    public function run()
    {
		$pages = array(
            ...
            array(
                ...
                'translated_from_page_id' => '0',
                'view'                    => null,
                'title'                   => 'Sidebar Model Creator',
                'http_verb'               => 'post',
                'route_name'              => 'dvs-models-create',
                'is_admin'                => '1',
                'dvs_admin'               => '1',
                'before'                  => 'canUseDeviseEditor',
                'after'                   => '',
                'slug'                    => '/admin/sidebar/models',
                'short_description'       => 'Create models using the devise sidebar front end editor',
                'response_type'           => 'Function',
                'response_path'           => 'Devise\Sidebar\ResponseHandler.requestCreateModel',
                'response_params'         => 'input'
            ),
            array(
                'language_id'             => '45',
                'translated_from_page_id' => '0',
                'view'                    => null,
                'title'                   => 'Sidebar Model Updater',
                'http_verb'               => 'put',
                'route_name'              => 'dvs-models-update',
                'is_admin'                => '1',
                'dvs_admin'               => '1',
                'before'                  => 'canUseDeviseEditor',
                'after'                   => '',
                'slug'                    => '/admin/sidebar/models',
                'short_description'       => 'Update models using the devise sidebar front end editor',
                'response_type'           => 'Function',
                'response_path'           => 'Devise\Sidebar\ResponseHandler.requestUpdateModel',
                'response_params'         => 'input'
            ),
            array(
                'language_id'             => '45',
                'translated_from_page_id' => '0',
                'view'                    => null,
                'title'                   => 'Sidebar Groups Updater',
                'http_verb'               => 'put',
                'route_name'              => 'dvs-model-groups-update',
                'is_admin'                => '1',
                'dvs_admin'               => '1',
                'before'                  => 'canUseDeviseEditor',
                'after'                   => '',
                'slug'                    => '/admin/sidebar/groups',
                'short_description'       => 'Update group using the devise sidebar front end editor',
                'response_type'           => 'Function',
                'response_path'           => 'Devise\Sidebar\ResponseHandler.requestUpdateGroup',
                'response_params'         => 'input'
            ),
            array(
                'language_id'             => '45',
