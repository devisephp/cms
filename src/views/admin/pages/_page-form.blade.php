...
<div class="dvs-form-group">
	...
	{{ Form::textarea('short_description', null, array('class' => 'short', 'placeholder'=>'Short Description')) }}
	<div class="dvs-helptext">
...
<div class="dvs-form-group">
    {{ Form::label('Route Permalink') }}
    {{ Form::text('slug', null, array('placeholder' => 'Permalink')) }}
    <div class="dvs-helptext">
