<div class="dvs-permission-group" data-operator="<?= (isset($operator)) ? $operator : 'and' ?>">
    <button class="dvs-remove-group dvs-button dvs-button-solid dvs-button-danger" <?= (!isset($subgroup)) ? 'style="display:none"' : '' ?> type="button">- Subgroup</button>
    <button class="dvs-add-group dvs-button dvs-button-solid" type="button">+ Subgroup</button>
    <button class="dvs-add-rule dvs-button dvs-button-solid" type="button">+ Rule</button>
