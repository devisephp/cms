...
<?= Form::open(array('class' => 'dvs-element-file', 'route' => array('dvs-fields-update', $element->id), 'method' => 'put', 'data-dvs-field-id' => $element->id, 'data-dvs-field-type' => $element->dvs_type, 'id' => 'dvs-sidebar-field-form')) ?>

    <div class="dvs-editor-values">
        <?= Form::label('File Path')?>
        <?= Form::text('file', $element->value->file,
                array(
