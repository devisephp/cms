...
Edit your existing api endpoint on this page.

### Name Of Request

The human name of the API request. Make this so you will recognize it.
...
The route name is unique to this API endpoint.

You cannot edit this route name once you have created an API. It should not change. The slug can change below but this remains the same in case it is referenced in other places throughout your application.
