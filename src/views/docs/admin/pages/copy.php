...
Copies an existing page. This might be to clone a page for translation into another language. You might just want to make copies of this page too?

Page copies should not be confused with page versions. This copy produces an entirely different page with a new url (slug). Page versions all share the same url.

### Version To Copy

This page version with all it's fields will be cloned with this new page.

### Title of the Page

The title of the page allows you to set a custom title on this specific page.
