<table style="font-family:'Lucida Grande', 'Lucida Sans Unicode', Arial, Verdana, sans-serif;font-size:12px;width:580px;border:10px solid #eaeaea" width="600">
	<tr>
		<td style="background-color:#eaeaea;height:3px;padding:8px 10px;"><img src="{{ URL::asset('/img/logo.png') }}" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td style="background-color:#ffffff;margin:5px 15px;">
			<p style="font-size:10px;color:#777;">If you need technical assistance or support, please contact our support team for assistance. To unsubscribe from receiving emails, click here to <a href="#REPLACE_HREF">unsubscribe</a>.</p>
