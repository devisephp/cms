...
class BlockTest extends \DeviseTestCase
{
	...
	{
        $obj = new Block;
        $node = m::mock('Devise\Pages\Interrupter\Nodes\IfNode');
        $obj->start($node);
	}
	...
	{
        $obj = new Block;
        $node = m::mock('Devise\Pages\Interrupter\Nodes\EndIfNode');
        $obj->stop($node);
	}
	...
	{
        $obj = new Block;
        $node = m::mock('Devise\Pages\Interrupter\Nodes\DeviseTagNode');
	...
	{
        $obj = new Block;
        $block = m::mock('Devise\Pages\Interrupter\Block');
        $obj->addBlock($block);
	}
	...
	{
        $obj = new Block;
        $child = m::mock('Devise\Pages\Interrupter\Block');
        $obj->addBlock($child);
	...
	public function test_block_can_get_tags()
	{
        $block1 = new Block;
        $block2 = new Block;
        $tag1 = m::mock('Devise\Pages\Interrupter\Nodes\DeviseTagNode');
        $tag2 = m::mock('Devise\Pages\Interrupter\Nodes\DeviseTagNode');
