  ...
  <div class="dvs-relative dvs-ml-8 dvs-px-1 dvs-py-1 dvs-rounded-sm dvs-text-xs dvs-cursor-pointer" :style="theme.panelSidebar" @click="toggleShowEditor">
    ...
    <template v-if="showEditor">
      <portal to="devise-root">
        ...
        <panel id="field-panel" class="dvs-fixed dvs-pin-b dvs-pin-r dvs-mx-8 dvs-mb-8 dvs-z-40 dvs-max-w-full" :panel-style="theme.panel">
          <div class="dvs-p-8">
            <h6 class="dvs-text-base dvs-mb-4" :style="{color: theme.panel.color}">
