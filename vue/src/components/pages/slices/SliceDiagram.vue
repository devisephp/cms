  ...
  methods: {
    ...
    getPreviewHtmlPart(description, columns, height) {
      ...
      if (type == 'F') {
        ...
        let submit = `<div style="background-color:rgba(255,255,255,0.4);height:30px;" class="dvs-p-1 dvs-w-full dvs-rounded-sm dvs-mb-4 dvs-flex dvs-justify-center dvs-items-center dvs-uppercase dvs-text-xs">Submit</div>`;
