      ...
      <div class="dvs-mb-12">
        <form>
          <fieldset class="dvs-fieldset dvs-mb-4">
            ...
            <input type="text" autocomplete="off" v-model="localValue.from_url" placeholder="Name of the Redirect">
          </fieldset>

          <fieldset class="dvs-fieldset dvs-mb-4">
            <label>To URL</label>
            <input type="text" autocomplete="off" v-model="localValue.to_url" placeholder="Email of the Redirect">
          </fieldset>
        </form>
